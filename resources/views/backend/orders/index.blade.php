    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          ...
          <!-- <a href="{{ route('admin.orders.create') }}" class="btn btn-success common-btn add-button" >  -->
          <!-- <i class="fa-solid fa-user-plus"></i> <span class="ml-2">Add New Order</span></a> -->
        </div>
        <div class="col-sm-6">
            ...
            <table id="ordersTable" class="table table-bordered" width="100%" cellspacing="0">
              <thead>
                <tr>
                    ...
                    <th class="user-th">Order No.</th>
                    <th class="user-th">Product Name</th>
                    <th class="user-th">Quantity</th>
                    <th class="user-th">Price</th>
                    <th class="user-th">Pyament Method</th>
                    <th class="user-th">Order Status</th>
                    <th class="user-th">Payment Status</th>
                    <th class="user-th">Item Status</th>
                ...
                <tr> 
                  ...
                  <th></th>
                  <th>
                    <select id="orderStatusSearch" class="form-select form-select-sm" onclick="event.stopPropagation()">
                  ...
                  <th> 
                    <select id="paymentStatusSearch" class="form-select form-select-sm" onclick="event.stopPropagation()">
                      <option value="">Select</option>
                  ...
                  <th>
                    <select id="itemStatusSearch" class="form-select form-select-sm" onclick="event.stopPropagation()">
                      <option value="">Select</option>
                      <option value="1">Active</option>
                      <option value="0">Inactive</option>
                    </select>
              ...
              <tbody>
                @if(!empty($orderData))
                  @php $i = 1; @endphp                  
                  @foreach($orderData as $ordersRes)
